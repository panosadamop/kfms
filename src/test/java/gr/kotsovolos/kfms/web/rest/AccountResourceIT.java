...
import static gr.kotsovolos.kfms.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static gr.kotsovolos.kfms.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static gr.kotsovolos.kfms.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import gr.kotsovolos.kfms.IntegrationTest;
import gr.kotsovolos.kfms.security.AuthoritiesConstants;
