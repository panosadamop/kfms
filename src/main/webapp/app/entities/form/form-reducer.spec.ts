...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './form.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FORM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FORM actions', async () => {
      const arg = 42666;
