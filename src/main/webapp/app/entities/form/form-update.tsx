...
export const FormUpdate = (props: RouteComponentProps<{ id: string }>) => {
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                type="date"
              />
              <ValidatedField id="form-user" name="user" data-cy="user" label={translate('kfmsApp.form.user')} type="select">
                <option value="" key="0" />
                {users
