...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORMTYPES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FORMTYPES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FORMTYPES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FORMTYPES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FORMTYPES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FORMTYPES actions', async () => {
      const arg = 42666;
