...
public class FormTypesResource {
    ...
    public ResponseEntity<FormTypes> createFormTypes(@Valid @RequestBody FormTypes formTypes) throws URISyntaxException {
        ...
        FormTypes result = formTypesService.save(formTypes);
        return ResponseEntity
            .created(new URI("/api/form-types/" + result.getId()))
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/form-types/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public ResponseEntity<List<FormTypes>> getAllFormTypes(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
    ...
    public ResponseEntity<FormTypes> getFormTypes(@PathVariable Long id) {
    ...
    public ResponseEntity<Void> deleteFormTypes(@PathVariable Long id) {
